...
//                });  
            ...
            case R.id.camera_get_version_btn:
                String mVersion = "";
                if (DJIDrone.getDroneType()!=DJIDroneType.DJIDrone_Vision) {
                    DJIDrone.getDjiCamera().getCameraFirmVersion("-",new DJIExecuteResultCallback(){
                        ...
                        public void onResult(DJIError mErr)
                        {
                            // TODO Auto-generated method stub
                            if (mErr.errorCode == DJIError.RESULT_OK){
                                String result = "the camera firmware version = "+DJIDrone.getDjiCamera().firmVersion;
                                handler.sendMessage(handler.obtainMessage(SHOWTOAST, result));
                            }else{
                                String result = "get camera firmware version errorCode =" + mErr.errorCode + "\n"+"errorDescription =" + DJIError.getErrorDescriptionByErrcode(mErr.errorCode);
                                handler.sendMessage(handler.obtainMessage(SHOWTOAST, result));
                            }
                        }
