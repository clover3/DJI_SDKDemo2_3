                ...
                mPopupNumberPicker = new PopupNumberPicker(m_context,
                        ...
                        new pickerValueChangeListener(){
                            ...
                            public void onValueChange(int pos1, int pos2) {
                                ...
                                if(pos1 == 1){
                                      DJIDrone.getDjiMainController().setMultiControlMode(true, new DJIExecuteResultCallback() {
                                        ...
                                        public void onResult(DJIError mErr)
                                        {
                                            ...
                                            if(mErr.errorCode == DJIError.RESULT_OK){
                                                DJIDrone.getDjiMainController().setAircraftFuctionType(DJIMcFunctionType.Enable_IOC, new DJIExecuteBooleanResultCallback() {
        ...
        mMcuUpdateStateCallBack = new DJIMcuUpdateStateCallBack(){
            ...
            public void onResult(DJIMainControllerSystemState state) {
                ...
                if (DJIDrone.getDroneType() != DJIDroneType.DJIDrone_Vision) {
                    sb.append("remoteControllerState=").append(state.remoteControllerState).append("\n");
                    sb.append("flightControlState=").append(state.fightControlState.toString()).append("\n");
                    ...
                    sb.append("isSwaveWork=").append(state.isUltrasonicWaveWork).append("\n");
                    sb.append("goHomeState=").append(state.goHomeStatus.toString()).append("\n");
                    sb.append("imuPreheated=").append(state.imuPreheated).append("\n");
                    sb.append("compassStatus=").append(state.compassStatus).append("\n");
                }
